...
const props = defineProps({ isProcessing: Boolean, permMode: String })
...
<template>
  <div id="input-area">
    ...
    <div id="input-row">
      ...
      <textarea id="input" v-model="inputText" rows="1" placeholder="输入消息..."
        @keydown.enter.prevent="!isProcessing && onSend()"></textarea>
