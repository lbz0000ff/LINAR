...
if _is_windows:
    ...
    FORBIDDEN_PATHS = [
        ...
        os.path.join(_sysroot, "System32", r"com\dmp"),
        ...
        os.path.join(_sysroot, "System32", r"Tasks\Microsoft\Windows\SystemRestore"),
        os.path.join(_sysroot, "System32", r"Tasks\Microsoft\Windows\RAC"),
        os.path.join(_sysroot, "System32", r"Tasks\Microsoft\Windows\DiskDiagnostic"),
